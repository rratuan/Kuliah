...
#I.S. : pengguna memasukkan Bulan, Tahun, NIP, Nama, Gol
...
def TampilPegawai(Bulan, Tahun, NIP, Nama, Gol, N):
    ...
    print('---------------------------------------------------------------------------------------------------------------------')
    print('| No |    NIP    |     Nama Pegawai     | Gol. |   Gaji Pokok   |   Tunjangan   |       PPN      |    Gaji Total    |')
    print('---------------------------------------------------------------------------------------------------------------------')
    ...
    for i in range(N):
        ...
        print(f'| {i+1:2} | {NIP[i]:9} | {Nama[i]:20} | {Gol[i]:4} | Rp. {GajiPokok:>10} | Rp. {Tunjangan:>9.1f} | Rp. {PPN:>10.1f} | Rp. {GajiTotal:>12.1f} |')
...
def MaxSortDsc(NIP, Nama, Gol, N):
    for i in range(N-1):
        max = i #Asumsikan Nilai Maksimum Ada Di Indeks i (Pertama)
        for j in range(i+1,N):
